...
<Nutshell children="Proof of Work (POW)" glossaryEntry="content/glossary/proof_of_work.mdx" />  and \[\[Proof of Stake]] (PoS) are two different types of consensus mechanisms used by some \[\[blockchain]]-based cryptocurrencies. These mechanisms are used to determine who will create the next block on the blockchain, and therefore play a crucial role in the functioning of these networks.
