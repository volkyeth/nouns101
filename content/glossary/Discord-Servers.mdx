...
###### [Discord](https://discord.com/) is a voice, video, and text chat app that's been adopted by web3, crypto, and NFT communities. In many cases NFT projects create Discord Servers to host their project, and various chat rooms for conversation around the project.&#x20;
