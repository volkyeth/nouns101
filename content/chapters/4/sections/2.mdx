...
**In short —** Each day a Noun is auctioned off 100% of the proceeds go to the Nouns Treasury. Nouns token holders put up proposals and each Noun token is equal to one vote on how the treasury is spent.&#x20;
