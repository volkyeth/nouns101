...
* Allow you to vote  in DAO <Nutshell children="governance" body={<>Governance plays a huge part in DAOs.      As a member of a DAO, you are entitled to voting on things that go on in the DAO.      In Lil Nouns DAO, members can vote on proposals - whether they'd like to see it happen or turn them down.</>} />.
