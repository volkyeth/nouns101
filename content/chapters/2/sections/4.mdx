...
Here you’ll be able to see the <Nutshell children="floor price" glossaryEntry="content/glossary/floor_price.mdx" /> of the collection, along with other <Nutshell children="collection attributes" />, \[\[traits]], and more.
