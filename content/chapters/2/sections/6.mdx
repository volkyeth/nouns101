...
**For MetaMask**, you can navigate to your Google Chrome Extension or web/mobile app and simply click your Account's wallet address to copy to your clipboard —&#x20;

![](/assets/copy-eth-address-metamask.gif)
...
If this is your first time transferring this particular NFT type on a marketplace, you may be asked to sign two transactions;

\#1. Is to allow the Opensea marketplace to access and transfer these tokens from your wallet.

\#2. Is a small gas-fee to initiate the transfer on the blockchain.
