...
\#1. The obvious way is to simply buy (or bid) one on an <Nutshell glossaryEntry="content/glossary/nft_marketplace.mdx" children="NFT Marketplace." />
...
**In the following sections we'll go over each of these three methods.**
