import ThirdParty from "../nutshells/third_party.mdx";
...
If you're on desktop, you have to find a <Nutshell term="third-party platform"><ThirdParty/></Nutshell> to transfer your NFTs.
