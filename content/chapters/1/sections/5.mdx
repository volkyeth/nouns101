...
Without the blockchain, crypto would not exist. For that reason, cryptocurrency is a <Nutshell glossaryEntry="content/glossary/peer_to_peer.mdx" children="peer-to-peer (P2P)" /> \[\[peer-to-peer (P2P) system]].
