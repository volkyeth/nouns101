...
Gas fees, also known as transaction fees, are fees paid in the native crypto of a blockchain network (ie: Ethereum, etc..) to <Nutshell children="Crypto Miners" glossaryEntry="content/glossary/Crypto-Miner.mdx" />  in order to have a transaction processed and added to the blockchain.&#x20;
