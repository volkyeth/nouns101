...
Although we suggest you *buy* your crypto on coinbase for ease, we suggest you *store* your crypto in a non-custodial wallet, like Metamask — We'll dive into this more later in the chapter. For now, here is a short video explaining the difference, and how to begin with Coinbase:
