...
\*\*Note: \*\*Throughout the chapters you'll see words highlighted, like <Nutshell glossaryEntry="" children="this." body={<>When you click them, definitions for these terms will be revealed.&#x20;</>} forceOpen={true} />
