...
**Note:** Throughout the chapters you'll see words highlighted, like <Nutshell glossaryEntry="" children="this." body={<>This is a "nutshell!";  Click on terms that look like this throughout Nouns101.wtf to expand the definitions.</>} forceOpen={true} />&#x20;
