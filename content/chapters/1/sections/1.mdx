...
**Note:** Throughout the chapters you'll see words highlighted, like <Nutshell glossaryEntry="content/glossary/Sample-nutshell.mdx" children="this." forceOpen={true} />&#x20;
